...
export default class Bullet extends GameObject {
    ...
    draw(_screen: vec2, i: number = 1) {
        ...
        const points: Point[] = ([new Point(x, y), new Point(x + 2, y - 2), new Point(x + 2, y - 2), new Point(x + 2, y - 2), new Point(x + 2, y + 2), new Point(x, y)].map(v => new Point(((v.x-x)*this.s)+x, ((v.y-y)*this.s)+y)))
        const draw = ((g: G) => {
            g.clear()
